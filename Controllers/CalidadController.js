...
Controller.NuevaInspeccion = (req, res) => {
    if (req.session.loggedin) {
        req.getConnection((err, conn) => {
            ...
            conn.query("INSERT INTO Inspeccion(Tipo,OT,CantidadOT,Notas,Operador,Serie,Parte,Familia,Maquina)VALUES" +
                "('" + N_Tipo + "','" + N_OT + "'," + N_CantidadOT + ",'" + N_Notas + "','"+N_Operador+"','"+N_Serie+"','"+N_Parte+"','"+N_Familia+"','"+N_Maquina+"')", (err, Herramientas) => {
                    if (err) {
